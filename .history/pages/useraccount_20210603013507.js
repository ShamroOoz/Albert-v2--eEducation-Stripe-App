      ...
      <div className="flex w-full h-screen overflow-hidden">
        <nav className="flex flex-col w-64 px-12 pt-4 pb-6 bg-gray-200">
          <div className="mt-8">
            ...
            <div className="mt-4 text-sm font-extrabold capitalize">
              {user?.email}
            </div>
          </div>
          ...
          <ul className="mt-2 text-gray-600">
            <li className="mt-8">
              <a href="#home" className="flex ">
                ...
                <span
                  className="ml-2 font-medium text-black capitalize "
                >
                  dashboard
                </span>
              </a>
            ...
            <li
              className="py-2 mt-8 -ml-4 bg-white rounded-lg shadow"
            >
              <a href="#home" className="flex pl-4">
                <UserIcon className="w-5 h-5 fill-current" />

                <span className="ml-2 font-medium capitalize">users</span>
              </a>
            </li>
        ...
        <main
          className="flex flex-col flex-1 overflow-y-auto transition duration-500 ease-in-out bg-gray-100"
        ></main>
      </div>
    </Layout>
  );
