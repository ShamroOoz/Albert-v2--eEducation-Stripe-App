    ...
    <Layout>
      <div className="flex w-full h-screen overflow-hidden">
        ...
        <main className="flex flex-col flex-1 overflow-y-auto transition duration-500 ease-in-out bg-gray-100">
          <div className="m-auto">Membership</div>
          <div className="fixed inset-0 z-50 flex items-center justify-center my-auto overflow-x-hidden overflow-y-auto outline-none min-w-screen focus:outline-none">
            <div className="relative w-full max-w-lg p-5 mx-auto my-auto bg-white shadow-lg rounded-xl ">
              <div className="">
                ...
                <div className="p-3 mt-2 space-x-4 text-center md:block">
                  <button claclassNamess="mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-full hover:shadow-lg hover:bg-gray-100">
                    Cancel
                  </button>
