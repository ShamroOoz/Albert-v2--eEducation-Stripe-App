        ...
        {user ? (
          !activeplan || activeplan.length < 0 ? (
            <>
              ...
              <section class="text-gray-200 bg-gray-900 mt-14">
                <div class="max-w-6xl mx-auto px-5 py-24 ">
                  <div class="text-center mb-20">
                    ...
                    <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">
                      L'informatique est vaste et les langages naissent presque
                      à tout moment, je fais tout mon possible pour être à la
                      hauteur afin de répondre au besoin de mes clients et
                      d'apporter de l'aide aux nouveaux développeurs.
                    </p>
