                  ...
                  <div className="max-w-6xl px-5 py-24 mx-auto ">
                    <div className="mb-20 text-center">
                      ...
                      <p className="mx-auto text-base leading-relaxed xl:w-2/4 lg:w-3/4">
                        L'informatique est vaste et les langages naissent
                        presque à tout moment, je fais tout mon possible pour
                        être à la hauteur afin de répondre au besoin de mes
                        clients et d'apporter de l'aide aux nouveaux
                        développeurs.
                      </p>
