  ...
  return (
    <div className="w-10/12 m-auto my-5 bg-white shadow-xl lg:w-4/12 md:6/12">
      <div className="px-8 py-8 rounded-xl">
            ...
            return (
              <Form>
                ...
                <button
                  ...
                  className="block px-3 py-2 font-semibold text-center text-white transition-colors duration-200 transform bg-indigo-600 border border-transparent rounded-md shadow-sm md:inline mt-2inline-flex whitespace-nowrap hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  Login
                </button>
              </Form>
        ...
        <div className="grid">
          <div>
            <button className="w-full p-3 text-center text-white duration-300 bg-black rounded-sm hover:bg-gray-400">
