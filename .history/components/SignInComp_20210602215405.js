  ...
  return (
    <div className="w-10/12 m-auto my-5 bg-white shadow-xl lg:w-4/12 md:6/12">
      <div className="px-8 py-8 rounded-xl">
        ...
        <div className="grid">
          <div>
            <button className="text-center text-white duration-300 bg-black rounded-sm max-w-xsp-3 hover:bg-blue-700">
              <img src={"/google.png"} className="" /> Sign in with Google
            </button>
          </div>
        </div>
      </div>
